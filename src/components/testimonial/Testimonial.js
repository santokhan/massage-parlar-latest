                                                    ...
                                                    <div className="flex gap-1 items-center text-yellow-500">
                                                        {
                                                            Array(5).fill(null).map((_, i) => (
                                                                <svg key={i} xmlns="http://www.w3.org/2000/svg" fill={i + 1 <= rating.ratings ? "currentColor" : "none"} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-5 w-5 flex-shrink-0">
